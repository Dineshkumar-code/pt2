...
def pt2device_check(dev, devh, ctrl):
...
#--------------------------------------Image storing and logging------------------

def img_storing(maxTemp, minTemp, img):
...
#-------------------------------lepton_img_streaming--------------------------

def lepton_img_streaming():
    """lepton_img_streaming"""
    global count
    count = 0
    while True:
